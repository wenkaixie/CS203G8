...
//         // Build MockMvc with the controller and service
//         mockMvc = MockMvcBuilders.standaloneSetup(eloController).build();
//     }

//     @Test
//     void testUpdateElo_Success() throws Exception {
//         // Mock the service call to prevent actual database interaction
//         doNothing().when(eloService).updateElo(anyString(), anyString(), anyDouble(), anyDouble(), anyDouble(), anyDouble());
