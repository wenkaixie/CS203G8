package com.app.tournament.controller2;
...
import com.app.tournament.DTO2.TournamentDTO;
...
import com.app.tournament.service2.TournamentService;

@CrossOrigin(origins = "http://localhost:3000")
@RestController
@RequestMapping("/api/tournaments2")
