...
const AdminDetailsHeader = ({ activeTab, tournamentTitle, playerCount, onEditClick, isEditMode, onSaveClick, onCancelClick }) => {
    ...
    const handleSaveClick = async () => {
        ...
        try {
            ...
            await axios.put(`http://matchup-load-balancer-1173773587.ap-southeast-1.elb.amazonaws.com:8080/api/tournaments/${tournamentId}`, tournamentData);
    ...
    const handleDeleteClick = async () => {
        try {
            ...
            await axios.delete(`http://matchup-load-balancer-1173773587.ap-southeast-1.elb.amazonaws.com:8080/api/tournaments/${tournamentId}`);
