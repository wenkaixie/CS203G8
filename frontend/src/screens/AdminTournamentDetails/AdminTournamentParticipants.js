...
const AdminTournamentParticipants = () => {
    ...
    useEffect(() => {
        const fetchTournamentData = async () => {
            try {
                const tournamentResponse = await axios.get(`http://matchup-load-balancer-1173773587.ap-southeast-1.elb.amazonaws.com:8080/api/tournaments/${tournamentId}`);
    ...
    const handleConfirmParticipants = async () => {
        try {
            await axios.post(`http://matchup-load-balancer-1173773587.ap-southeast-1.elb.amazonaws.com:8080/api/tournaments/${tournamentId}/generateRounds`);
    ...
    const handleDeleteParticipant = async (authId) => {
        ...
        if (confirmDelete) {
            try {
                await axios.delete(`http://matchup-load-balancer-1173773587.ap-southeast-1.elb.amazonaws.com:8080/api/tournaments/${tournamentId}/players/${authId}`);
